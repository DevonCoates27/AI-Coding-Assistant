...
void CompileJob::Execute(){
    ...
    std::string command = "make compileCode"; //TYPE THE COMMAND TO RUN WHICH RULE YOU WANT HERE
    ...
    while(fgets(buffer.data(), 1024, pipe) != NULL){
...
void CompileJob::JobCompleteCallback() {
    ...
    std::ofstream out("Data/errors.json", std::ios::out);
